...
const styles = StyleSheet.create({
    ...
    addBtn: {
        ...
        backgroundColor: SgateColors.black, alignItems: 'center', justifyContent: 'center',
    },
    ...
    typeBubble: { width: 46, height: 46, borderRadius: 14, alignItems: 'center', justifyContent: 'center', marginTop: 2 },
    cardInfo: { flex: 1 },
    cardRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 },
    cardName: { fontSize: 15, fontFamily: SgateFonts.semibold, color: SgateColors.t1, flex: 1, marginRight: 8 },
    statusBadge: { borderRadius: 10, paddingHorizontal: 8, paddingVertical: 3 },
    statusText: { fontSize: 10, fontFamily: SgateFonts.bold, letterSpacing: 0.5 },
    ...
    schedText: { fontSize: 12, fontFamily: SgateFonts.regular, color: SgateColors.t3 },
    menuBtn: { paddingTop: 2 },
    categoryRow: { paddingHorizontal: 14, paddingBottom: 12 },
    categoryText: { fontSize: 12, fontFamily: SgateFonts.medium, color: SgateColors.t3, textTransform: 'capitalize' },

    empty: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingTop: 80, paddingHorizontal: 36, gap: 10 },
    emptyTitle: { fontSize: 18, fontFamily: SgateFonts.bold, color: SgateColors.t1, marginTop: 8 },
    emptySubtitle: { fontSize: 13, fontFamily: SgateFonts.regular, color: SgateColors.t3, textAlign: 'center', lineHeight: 20 },
    emptyBtn: { marginTop: 12, backgroundColor: SgateColors.black, paddingHorizontal: 28, paddingVertical: 13, borderRadius: 14 },
    emptyBtnText: { fontSize: 14, fontFamily: SgateFonts.semibold, color: SgateColors.card },
    ...
    actionHandle: { width: 36, height: 4, borderRadius: 2, backgroundColor: SgateColors.border, alignSelf: 'center', marginBottom: 16 },
    actionTitle: { fontSize: 14, fontFamily: SgateFonts.semibold, color: SgateColors.t3, marginBottom: 14 },
    actionItem: {
        flexDirection: 'row', alignItems: 'center',
        paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: SgateColors.borderSoft, gap: 12,
    },
