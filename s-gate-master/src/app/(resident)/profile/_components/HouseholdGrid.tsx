...
function Tile({ title, subtitle, iconName, iconBg, iconColor, error, onPress, onRetry }: TileProps) {
    if (error) {
        return (
            <TouchableOpacity style={styles.tile} onPress={onRetry} activeOpacity={0.7}>
