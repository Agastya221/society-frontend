...
const EMERGENCIES: EmergencyType[] = [
  ...
  },
  {
    ...
    color: '#2563EB',
    bgColor: '#DBEAFE',
    description: 'Medical emergency or injury',
  },
  {
    title: 'SECURITY',
    icon: 'shield',
    color: '#DC2626',
    bgColor: '#FEE2E2',
    description: 'Security threat or breach',
  },
  {
    title: 'LIFT TRAPPED',
    icon: 'alert-circle',
...
export default function EmergenciesScreen() {
  ...
  const raiseEmergency = (type: string) => {
      ...
      >
        {EMERGENCIES.map((emergency, index) => (
          <EmergencyCard 
            ...
            emergency={emergency}
            index={index}
            onPress={() => raiseEmergency(emergency.title)}
          />
        ))}
        ...
        <View style={styles.helpSection}>
          ...
          <View style={styles.helpItem}>
            ...
            <Text style={styles.helpText}>All residents receive instant notification</Text>
          </View>
          <View style={styles.helpItem}>
            <Ionicons name="checkmark-circle" size={20} color="#10B981" />
            <Text style={styles.helpText}>Admin team is alerted immediately</Text>
          </View>
          <View style={styles.helpItem}>
            <Ionicons name="checkmark-circle" size={20} color="#10B981" />
            <Text style={styles.helpText}>Emergency services may be contacted</Text>
          </View>
        </View>
      </ScrollView>
    </View>
    ...
    >
      ...
      >
        ...
        <View style={styles.cardContent}>
          <Text style={[styles.cardTitle, { color: emergency.color }]}>
            {emergency.title}
          </Text>
